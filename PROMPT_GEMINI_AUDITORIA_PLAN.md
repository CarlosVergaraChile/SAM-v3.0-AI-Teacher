# PROMPT PARA GEMINI - AUDITORÍA DEL PLAN COMERCIAL SAM v3.0

---

## INSTRUCCIONES PARA GEMINI

Eres un auditor empresarial independiente de clase mundial. Tu rol es evaluar el plan comercial para vender SAM v3.0 (plataforma de IA para educación) con **integridad, precisión y equilibrio**.

Revisa el plan completo a continuación y proporciona:

1. **Evaluación de Viabilidad** - ¿Es realista este plan?
2. **Análisis de Riesgos** - ¿Qué puede fallar?
3. **Sesgo Detectado** - ¿Hay optimismo excesivo?
4. **Fortalezas** - ¿Qué está bien hecho?
5. **Debilidades** - ¿Qué falta?
6. **Recomendaciones** - ¿Cómo mejorarlo?
7. **Veredicto Final** - ¿Apruebas este plan?
...
Por favor, responde a cada una con honestidad y rigor:

### 1. Evaluación de Viabilidad

**¿Es realista vender SAM v3.0 a $500K-$1.5M en 10-16 semanas?**

- Considera: tiempo de decisión corporativo, due diligence, negociación
- ¿Qué tan probable es este timeline?
- ¿Qué variables están fuera de control?

### 2. Análisis de Asunciones

**¿Qué asunciones son problemáticas?**

- Break-even @ 47K usuarios: ¿Realista o optimista?
- Margen 40-57%: ¿Sostenible?
- ROI 127-240%: ¿Verificable?

### 3. Sesgo Detectado

**¿Ve sesgo hacia el optimismo?**

- ¿Se minimizan riesgos?
- ¿Se exageran beneficios?
- ¿Hay omisiones estratégicas?

### 4. Variables Críticas Faltantes

**¿Qué variables son esenciales y faltan?**

- CAC (Customer Acquisition Cost)
- Churn rate
- LTV (Customer Lifetime Value)
- Sales cycle realista
- CAC payback period

### 5. Fortalezas del Plan
...
- Timeline ajustado (vs inicial)

### 6. Debilidades Críticas

**¿Qué debería arreglarse antes de vender?**
...
**¿Qué cambios mejorarían el plan?**

1. Corto plazo (semanas)
2. Mediano plazo (meses)
3. Largo plazo (trimestres)

### 8. Veredicto Final

**¿Apruebas este plan para ejecutar venta AHORA?**
...
Este plan fue auditado previamente por DeepSeek (análisis técnico) con resultado: ✅ **95% confianza técnica**

Ahora requerimos tu análisis independiente de integridad y equilibrio.

La confianza final será el promedio ponderado de ambos análisis.
...
**Confianza:** [0-100%]
**Recomendación Ejecutiva:** [Tu recomendación]
**Próximos Pasos:** [Qué hacer]
```

---

Gracias por tu auditoría honesta e independiente.
